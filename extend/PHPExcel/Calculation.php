...
if (!defined('CALCULATION_REGEXP_CELLREF')) {
    //    Email for support of \P (multibyte options) in PCRE
...
class Calculation {
    ...
    public function setLocale($locale = 'en_us') {
        ...
        //    Email whether we have any language data for this language (any locale)
...
//echo 'Email cache for ',$worksheetName,'!',$cellID,PHP_EOL;
...
//                        echo 'Element '.$localeConstant.' is an Excel Constant<br />';
            ...
            //    Email for end of formula string
