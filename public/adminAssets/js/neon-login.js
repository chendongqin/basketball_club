...
;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
		...
		// #modify 验证码
		neonLogin.$container.on('click','.captcha',function(){
			$(this).find('img').attr('src','/i/captcha/?channel=login&v='+(+new Date));
		});
						...
						success: function(json){						
							...
							setTimeout(function(){
								if(json['status']){
									...
									$(".form-login-error").find('p').text(json['msg']);
