<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:86:"D:\phpstudy\WWW\basketballClub\public/../application/admin\view\management\index.phtml";i:1526280366;s:66:"D:\phpstudy\WWW\basketballClub\application\admin\view\layout.phtml";i:1520904787;s:45:"../application/admin/view/public/header.phtml";i:1520910917;s:46:"../application/admin/view/public/sidebar.phtml";i:1526281007;s:47:"../application/admin/view/public/userinfo.phtml";i:1520907425;s:44:"../application/index/view/public/pager.phtml";i:1525152262;s:45:"../application/admin/view/public/footer.phtml";i:1522509903;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="dataTables_wrapper form-inline">
    <div class="row screen-sm">
        <div class="col-md-12 col-left">
            ...
            <div class="col-md-2" ><a href="javascript:;" class="btn btn-green" id="addAdmin">添加</a></div>
        </div>
    </div>
</div>
<div class="table-responsive">
    <table class="table table-bordered table-striped custom-table-font-size">
        ...
        <?php if(!empty($pager['data'])):foreach ($pager['data'] as $key=>$value):?>
            ...
            <?php endforeach;else:?>
            <td colspan="17"><center>没有找到管理员</center></td>
        <?php endif;?>
        </tbody>
    </table>
</div>
