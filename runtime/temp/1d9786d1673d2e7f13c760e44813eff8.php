    ...
    <div class="event-list">
        <?php if(!empty($pager['data'])):foreach ($pager['data'] as $key=>$data):?>
                <div class="list-show">
                    ...
                    <li><span><?php echo $data['start_time'].'至'.$data['end_time'];?></span><a href="/user/event/datadetail?id=<?php echo $data['Id'];?>">进入比赛</a></li>
                </div>
            <?php endforeach;else:?>
